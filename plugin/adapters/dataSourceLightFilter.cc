...
MoonrayDataSourceLightFilter::MoonrayDataSourceLightFilter(
...
TfTokenVector
MoonrayDataSourceLightFilter::GetNames()
{
...
MoonrayDataSourceLightFilter::Get(const TfToken &name)
{
...
MoonrayDataSourceLightFilterPrim::MoonrayDataSourceLightFilterPrim(
        const SdfPath &sceneIndexPath,
        UsdPrim usdPrim,
        const UsdImagingDataSourceStageGlobals &stageGlobals)
...
TfTokenVector 
MoonrayDataSourceLightFilterPrim::GetNames()
{
...
HdDataSourceBaseHandle 
MoonrayDataSourceLightFilterPrim::Get(const TfToken & name)
{
    if (name == moonrayToken) {
        return MoonrayDataSourceLightFilter::New(
            _GetSceneIndexPath(),
            _GetUsdPrim(),
            _GetStageGlobals());
    } else {
...
MoonrayDataSourceLightFilterPrim::Invalidate(
    UsdPrim const& prim,
